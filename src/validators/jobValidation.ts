...
const jobStatusEnum = z.enum(["APPLIED", "INTERVIEW", "OFFER", "REJECTED", "HIRED"],
    {
        errorMap: () => ({
            message: "Invalid job status provided. Please use one of the following: APPLIED, INTERVIEW, OFFER, REJECTED, HIRED."
        })
    }
);
